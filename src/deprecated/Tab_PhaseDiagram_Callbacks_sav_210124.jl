function Tab_PhaseDiagram_Callbacks(app)
    ...
    callback!(
        ...
        if bid == "compute-button"
            ...
            global n_lbl                = 0;
            global data_plot, layout, data_isopleth, PT_infos, infos;
        ...
        elseif bid == "button-add-isopleth"
            ...
            fig         = plot( vcat(data_plot,data_isopleth.isoP[data_isopleth.active]), layout)
            grid        = "false"; full_grid        = "false"
        elseif bid == "button-remove-isopleth"
            ...
            if (isoplethsID) in data_isopleth.active
                ...
                fig         = plot(data_isopleth.isoP[data_isopleth.active], layout)
        ...
        elseif bid == "button-show-all-isopleth"
            ...
            data_isopleth.isoP[1] = data_plot
            fig         = plot( vcat(data_plot,data_isopleth.isoP[data_isopleth.active]), layout)
            grid        = "false"
