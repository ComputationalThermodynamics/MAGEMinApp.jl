...
push!(dbte,Dict(    :composition=> "predefined",
                    ...
                    :test       => 1,
                    :elements   => ["Li","Cs","Be","Rb", "Ba", "Th", "U", "Nb", "Ta", "La", "Ce", "Pb", "Pr", "Sr", "Nd", "Zr", "Hf", "Sm", "Eu", "Gd", "Tb", "Dy", "Y", "Ho", "Er", "Tm", "Yb", "Lu", "V", "Sc"],
                    :μg_g        => [20.0,0.3,1.0,16.60777308, 122.8449739, 1.074692058, 0.290233271, 3.808354064, 0.330971265, 6.938172601, 16.04827796, 5.452969044, 2.253943183, 163.4533209, 10.18276823, 66.90677472, 1.841502082, 3.3471043, 0.915941652, 3.28230146, 1.417695298, 3.851230952, 20.74016207, 0.914966282, 2.20425, 0.343734976, 2.136202593, 0.323405135, 257.4346716, 38.23663423],
                    :μg_g2       => [20.0,0.3,1.0,16.60777308, 122.8449739, 1.074692058, 0.290233271, 3.808354064, 0.330971265, 6.938172601, 16.04827796, 5.452969044, 2.253943183, 163.4533209, 10.18276823, 66.90677472, 1.841502082, 3.3471043, 0.915941652, 3.28230146, 1.417695298, 3.851230952, 20.74016207, 0.914966282, 2.20425, 0.343734976, 2.136202593, 0.323405135, 257.4346716, 38.23663423],
                ), cols=:union)
...
push!(dbte,Dict(    :composition=> "predefined",
                    ...
                    :test       => 2,
                    :elements   => ["Li","Cs","Be","Rb", "Ba", "Th", "U", "Nb", "Ta", "La", "Ce", "Pb", "Pr", "Sr", "Nd", "Zr", "Hf", "Sm", "Eu", "Gd", "Tb", "Dy", "Y", "Ho", "Er", "Tm", "Yb", "Lu", "V", "Sc"],
                    :μg_g        => [1.5,0.03,0.025,0.6,6.6,0.0795,0.0203,0.658,0.037,0.648,1.675,0.150,0.254,19.9,1.25,10.5,0.283,0.406,0.154,0.544,0.099,0.674,4.30,0.149,0.438,0.068,0.441,0.0675,8.2,16.2],
