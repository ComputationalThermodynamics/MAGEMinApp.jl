...
# #MANTLE DATABASE STIXRUDE 2024
    ...
    push!(dbte,Dict(    :composition=> "predefined",
                        ...
                        :comments   => "J-F Moyen",
                        :test       => 0,
                        :elements   => ["S","P2O5","Rb", "Ba", "Th", "U", "Nb", "Ta", "La", "Ce", "Pb", "Pr", "Sr", "Nd", "Zr", "Hf", "Sm", "Eu", "Gd", "Tb", "Dy", "Y", "Ho", "Er", "Tm", "Yb", "Lu", "V", "Sc", "Cs", "K", "Ti"],
    ...
    push!(dbte,Dict(    :composition=> "predefined",
                        ...
                        :test       => 2,
                        :elements   => ["S","P2O5","Rb", "Ba", "Th", "U", "Nb", "Ta", "La", "Ce", "Pb", "Pr", "Sr", "Nd", "Zr", "Hf", "Sm", "Eu", "Gd", "Tb", "Dy", "Y", "Ho", "Er", "Tm", "Yb", "Lu", "V", "Sc", "Cs", "K", "Ti"],
                        :μg_g        => round.([50.0,50.0,0.6,6.6,0.0795,0.0203,0.658,0.037,0.648,1.675,0.150,0.254,19.9,1.25,10.5,0.283,0.406,0.154,0.544,0.099,0.674,4.30,0.149,0.438,0.068,0.441,0.0675,8.2,16.2,0.021,240.0,1205.0],digits=2),
                        :μg_g2       => round.([50.0,50.0,0.6,6.6,0.0795,0.0203,0.658,0.037,0.648,1.675,0.150,0.254,19.9,1.25,10.5,0.283,0.406,0.154,0.544,0.099,0.674,4.30,0.149,0.438,0.068,0.441,0.0675,8.2,16.2,0.021,240.0,1205.0],digits=2),
                    ), cols=:union)
